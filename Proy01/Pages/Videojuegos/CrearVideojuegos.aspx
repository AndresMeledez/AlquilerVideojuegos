<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearVideojuegos.aspx.cs" Inherits="Proy01.Pages.Videojuegos.CrearVideojuegos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="gv-formulario">
        ...
        <asp:HyperLink ID="lnkRegresar" runat="server" CssClass="btn gv-btn-secundario" NavigateUrl="~/Pages/Videojuegos/ListaVideojuegos.aspx">Regresar</asp:HyperLink>
    </div>
</asp:Content>
